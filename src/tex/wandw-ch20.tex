...
series defining ip (z) is 0(\ flm,n\~% and so (§3-4) the series
...
roots of the sextic. (Trinity, 1898.)
...
re2:)eated factors, then, by § 20"6, <I> z) = z + a) + A, where a is
...
replaced (cf. § 20-222) by the sine of a multiple of z, and if the
