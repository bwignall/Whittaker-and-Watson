...
\Section{9}{1}{Definition of Fourier series}*. Series of the type
...
If there is a function TODO such that I f t) dt exists as a Riemann
integral
...
* Throughout this chapter (except in\hardsubsectionref{9}{1}{1}) it is supposed that all
...
Abel's theorem \hardsectionref{3}{7}l),
...
Xow 2 - converges uniformly \hardsubsectionref{3}{3}{5} example 1) and is therefore con-
...
The series converges only when x is real; by\hardsubsectionref{3}{3}{4} the convergence
...
from to x \hardsectionref{4}{7}), and consequently

1 2 I (-)"- (l-C0Sn.r),;i,,;5N

2 -= 2 -2 -71 + 8 x 77 -d).

* The series do converge if y - 0, see\hardsubsectionref{2}{3}{1} example 2.
...
by* cos nx or by sin nx and integrating term -by-term i* \hardsectionref{4}{7}),
...
nxllog n, which con- verges for all real values of x \hardsubsectionref{2}{3}{1} example
...
a single analytical ex- pression for all real values of t. Cf.\hardsubsectionref{9}{1}{1}
example 1.
...
X The limits / (.r ± 0) exist, by\hardsubsectionref{3}{6}{4} example 3. § Cf. example 6 at
...
\Section{9}{3}{The nature of the coefficients in a Fourier series.}*
...
* The analysis of this section and of\hardsubsectionref{9}{3}{1} is contained in Stokes'
