...
integral $\int_0^\infty t^{z - 1} e^{-t} \mathrm{d}t$; but in
...
$ze^{\gamma z} \prod_{n=1}^\infty \left{ \left(1 + \frac{z}{n} \right)
    e^{-\frac{z}{n}}\right}$, where
$\gamma = \lim_{m \rightarrow \infty} \left{ \frac{1}{1} + \frac{1}{2}
...
\begin{displaymath}
u_n = \int_0^1 \frac{t}{n (n + t)} \mathrm{d}t = \frac{1}{n} -
log\frac{n+1}{n} ,
\end{displaymath}


$u_n$ Is positive and less than $\int_0^1 \frac{\mathrm{d}t}{n^2}$;
therefore $\sum_{n=}^\infty u_n$ converges, and 
\begin{displaymath}
  \lim_{m \rightarrow \infty} \left{ \frac{1}{1} + \frac{1}{2}
...
\frac{1}{2} N$, we have$^\dagger$\footnote{Taking the principal value
...
consequently its exponential 11 ( l+-]e~nl is an analytic function,
and
...
\Section{12}{11}{Euler's TODO formula for the Gamma-function.}
