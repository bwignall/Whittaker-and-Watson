...
integral $\int_0^\infty t^{z - 1} e^{-t} \dd t$; but in
...
$ze^{\gamma z} \prod_{n=1}^\infty \left\{ \left(1 + \frac{z}{n} \right) e^{-\frac{z}{n}}\right\}$, where
...
\begin{displaymath}
u_n = \int_0^1 \frac{t}{n (n + t)} \dd t = \frac{1}{n} -
\log\frac{n+1}{n} ,
\end{displaymath}


$u_n$ Is positive and less than $\int_0^1 \frac{\dd t}{n^2}$;
