...
\newcommand{\littleo}{o}
\newcommand{\binomialcoeff}[2]{ \binom{#1}{#2} }
...
\newenvironment{wandwmiscexamples}{\begin{enumerate}}{\end{enumerate}}
\newenvironment{wandwmiscexample}{\item}{ }

\newcommand{\wandwtypo}[2]{#2} %\wandwtypo{orig}{fix}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\input{wandw-frontmatter.tex}
%\shorttoc{Contents}{0}
\tableofcontents
\part{The Processes of Analysis}
\input{wandw-ch01.tex}
\input{wandw-ch02.tex}
\input{wandw-ch03.tex}
\input{wandw-ch04.tex}
\input{wandw-ch05.tex}
\input{wandw-ch06.tex}
\input{wandw-ch07.tex}
\input{wandw-ch08.tex} % First section done
\input{wandw-ch09.tex}
\input{wandw-ch10.tex}
\input{wandw-ch11.tex}

\part{The Transcendental Functions}
\input{wandw-ch12.tex}
\input{wandw-ch13.tex}
\input{wandw-ch14.tex}
\input{wandw-ch15.tex}
\input{wandw-ch16.tex}
\input{wandw-ch17.tex} % First pass complete; missing references
\input{wandw-ch18.tex}
\input{wandw-ch19.tex}
\input{wandw-ch20.tex}
\input{wandw-ch21.tex}
\input{wandw-ch22.tex}
\input{wandw-ch23.tex}

\appendix
\input{wandw-appendix.tex}

\input{wandw-index-todo.tex}
\printindex
