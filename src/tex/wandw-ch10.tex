...
theorem,
\begin{align*}
  P(z-c) =& p_{0} + p_{1} (z-c) + p_{2} (z-c)^{2} + \cdots, \\
  Q(z-c) =& q_{0} + q_{1} (z-c) + q_{2} (z-c)^{2} + \cdots,
\end{align*}
...
Let us assume as a \emph{formal} solution of the equation
$$
u
=
(z-c)^{\alpha}
...
$$
where $\alpha, a_{1}, a_{2}, \ldots$ are constants to be determined.
%
% 198
%
