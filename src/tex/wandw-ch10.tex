...
It is easily seen \hardsubsectionref{5}{2}{2}) that an ordinary point of equation (A) is
...
verges, it follows \hardsubsectionref{3}{3}{4}) that v z)= 2 v (z) is a series of analytic
functions
...
equate coefficients of successive powers of - 6 to zero \hardsubsectionref{3}{7}{3}) to
...
not, in general, ' analytic throughout S ' \hardsectionref{5}{2} cor. 2, footnote),
...
F (pi + n) = n(s+ 71). Now, by\hardsubsectionref{5}{2}{3}, we can find a positive number M
...
where C is a determinate constant. (Lindemann; see\hardsectionref{19}{5}.)
