...
and it will be assumed that there is a domain 8 in which both p  z), q (z) are 
analytic except at a finite number of poles. 

Any point of *S  at which p (z), q (z) are both analytic will be called an 
ordinary point of the equation ; other points of 8 will be called singular 
points. 

10'2. 8olutionf of a differential equation valid in t/ie vicinity of an 
ordinary point.. 
...
radius of the circle being such that every point of 8  is a point of  S', and is 
...
to equations of any order, see Forsyth, Theory of Diff'erential Equations, iv. (1902), Ch. i. 
...
where Pq, pi, ..., g , qi, ••• are constants; and these series converge in the 
