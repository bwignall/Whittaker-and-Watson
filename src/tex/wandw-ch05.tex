...
5 1-5 "12] FUNDAMENTAL PROPERTIES OF ANALYTIC FUNCTIONS 83 
...
t The words ' regular ' and ' holomorphic ' are sometimes used. A distinctiou has been made 
...
the boundar ' of the continuum let numbers f (z), S (S depending on z) exist 
...
axes in the manner of § .5"13 ; then the interior of Cis divided into a number 
...
The right-hand side of the last inequality tends to zero as ?? — > oo . We 
have therefore 
...
-— I sm (2m cos  ) cos Ji o? . 
•2ir J  )   • 

n=i n-z' + a- 

shew that/ (2) is finite and continuous for all real values of z, but cannot be expanded as 
...
Bidl. des Set. Math. (2), xiv. (1890), pp. 145-599 ; Lerch, Journal fiir Math. cm. (1888), 
pp. 126-138; Pringsheim, Math. Ann. XLii. (1893), pp. 153-184 ; and Du Bois Reymond, 
Miinehener Sitzungsberichte, vi. (1876), p. 235.] 
...
analytic (§ 5*1) and so (§ 5*22) its derivate /(z) is also analytic. This important converse 
