...
Consider $\int_{C} Q(z) \dmeasure z$ taken round a contour $C$ consisting of the part of
the real axis joining the points $\pim\rho$ (where $\rho > \rho_{0}$) and a semicircle $\Gamma$, of
radius $\rho$, having its centre at the origin, above the real axis.
